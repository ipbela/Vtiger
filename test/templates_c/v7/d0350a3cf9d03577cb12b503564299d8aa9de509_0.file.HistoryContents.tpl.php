<?php
/* Smarty version 4.5.2, created on 2024-11-02 19:20:00
  from 'C:\xampp\htdocs\VCRM\layouts\v7\modules\Vtiger\dashboards\HistoryContents.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.2',
  'unifunc' => 'content_67267b6018fe39_20152546',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd0350a3cf9d03577cb12b503564299d8aa9de509' => 
    array (
      0 => 'C:\\xampp\\htdocs\\VCRM\\layouts\\v7\\modules\\Vtiger\\dashboards\\HistoryContents.tpl',
      1 => 1715748848,
      2 => 'file',
    ),
  ),
...
function content_67267b6018fe39_20152546 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
?>
 ...
 <a class="cursorPointer" <?php if (stripos($_smarty_tpl->tpl_vars['DETAILVIEW_URL']->value,'javascript:') === 0) {?>
																								  onclick='<?php echo substr((string) $_smarty_tpl->tpl_vars['DETAILVIEW_URL']->value, (int) strlen("javascript:"));?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
							...
							<?php } elseif ($_smarty_tpl->tpl_vars['HISTORY']->value->isCreate()) {?>
								<div>
									...
									<a class="cursorPointer" <?php if (stripos($_smarty_tpl->tpl_vars['DETAILVIEW_URL']->value,'javascript:') === 0) {?> onclick='<?php echo substr((string) $_smarty_tpl->tpl_vars['DETAILVIEW_URL']->value, (int) strlen("javascript:"));?>
' <?php } else { ?> onclick='window.location.href="<?php echo $_smarty_tpl->tpl_vars['DETAILVIEW_URL']->value;?>
								...
								<div>
									...
									<?php if ($_smarty_tpl->tpl_vars['RELATION']->value->getLinkedRecord()->getModuleName() == 'Calendar') {?>
										<?php if (isPermitted('Calendar','DetailView',$_smarty_tpl->tpl_vars['RELATION']->value->getLinkedRecord()->getId()) == 'yes') {?>
											<a class="cursorPointer" <?php if (stripos($_smarty_tpl->tpl_vars['LINKED_RECORD_DETAIL_URL']->value,'javascript:') === 0) {?> onclick='<?php echo substr((string) $_smarty_tpl->tpl_vars['LINKED_RECORD_DETAIL_URL']->value, (int) strlen("javascript:"));?>
'
...
echo vtranslate('LBL_FOR');?>
 <a class="cursorPointer" <?php if (stripos($_smarty_tpl->tpl_vars['PARENT_DETAIL_URL']->value,'javascript:') === 0) {?>
							   onclick='<?php echo substr((string) $_smarty_tpl->tpl_vars['PARENT_DETAIL_URL']->value, (int) strlen("javascript:"));?>
