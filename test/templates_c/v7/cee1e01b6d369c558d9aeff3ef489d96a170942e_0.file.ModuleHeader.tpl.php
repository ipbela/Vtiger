<?php
/* Smarty version 4.5.2, created on 2024-09-17 22:07:11
  from 'C:\xampp\htdocs\VCRM\layouts\v7\modules\Settings\Vtiger\ModuleHeader.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.2',
  'unifunc' => 'content_66e9fd8f342920_78020233',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'cee1e01b6d369c558d9aeff3ef489d96a170942e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\VCRM\\layouts\\v7\\modules\\Settings\\Vtiger\\ModuleHeader.tpl',
      1 => 1715748848,
      2 => 'file',
    ),
  ),
...
function content_66e9fd8f342920_78020233 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\xampp\\htdocs\\VCRM\\vendor\\smarty\\smarty\\libs\\plugins\\modifier.explode.php','function'=>'smarty_modifier_explode',),1=>array('file'=>'C:\\xampp\\htdocs\\VCRM\\vendor\\smarty\\smarty\\libs\\plugins\\modifier.count.php','function'=>'smarty_modifier_count',),));
?>
...
" type="button" class="btn addButton btn-default module-buttons"<?php if (stripos($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getUrl(),'javascript:') === 0) {?>onclick='<?php echo substr((string) $_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getUrl(), (int) strlen("javascript:"));?>
...
"<?php if (stripos($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getUrl(),'javascript:') === 0) {?>onclick='<?php echo substr((string) $_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getUrl(), (int) strlen("javascript:"));?>
...
"><a	<?php if (stripos($_smarty_tpl->tpl_vars['SETTING']->value->getUrl(),'javascript:') === 0) {?>onclick='<?php echo substr((string) $_smarty_tpl->tpl_vars['SETTING']->value->getUrl(), (int) strlen("javascript:"));?>
...
if (stripos($_smarty_tpl->tpl_vars['LISTVIEW_BASICACTION']->value->getUrl(),'javascript:') === 0) {?>onclick='<?php echo substr((string) $_smarty_tpl->tpl_vars['LISTVIEW_BASICACTION']->value->getUrl(), (int) strlen("javascript:"));?>
